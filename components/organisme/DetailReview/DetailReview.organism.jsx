...
import ReviewAnimation from '@/components/molecules/ReviewAnimation/ReviewAnimation.molecule';
import {
  useReviewBookSelector,
  useReviewTypeSelector,
...
const DetailReview = () => {
  ...
  const type = useReviewTypeSelector();
  const loading = type === retrieveReviewBook.pending.type;
